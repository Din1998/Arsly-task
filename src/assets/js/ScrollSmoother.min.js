...
!function(e, t) {
    ...
    function ScrollSmoother(t) {
        ...
        var n, S, e, i, b, s, a, l, c, f, r, u, h, d, g, p, m = t.smoothTouch, w = t.onUpdate, T = t.onStop, _ = t.smooth, C = t.onFocusIn, P = t.normalizeScroll, x = t.wholePixels, R = this, E = t.effectsPrefix || "", k = Y.getScrollFunc(U), H = 1 === Y.isTouch ? !0 === m ? .8 : parseFloat(m) || 0 : 0 === _ || !1 === _ ? 0 : parseFloat(_) || .8, A = H && +t.speed || 1, N = 0, F = 0, B = 1, M = J(0), z = {
            y: 0
        ...
        Y.config(t),
        "overscrollBehavior"in U.getComputedStyle(K) && I.set([K, G], {
